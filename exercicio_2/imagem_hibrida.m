%ATIVIDADE 2
%DANIEL MORAIS
%Implementar e gerar uma imagem hÃ­brida conforme o artigo https://dl.acm.org/citation.cfm?id=1141919
...
for u = 1:m
     for v = 1:n
         D = sqrt((u-m/2)^2+(v-n/2)^2);     % DISTÂNCIA EUCLIDIANA        
         if D > D0
...
% CONVERTE DO DOMÍNIO DA FREQUENCIA PARA O ESPACIAL
